...
desired_caps['app'] = os.path.abspath('/Users/WSU/Library/Developer/Xcode/DerivedData/Client-elgfethedbgmomhgdohowwlruvgz/Build/Products/Fennec-iphonesimulator/Client.app')
